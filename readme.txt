...
2.4 Posts: Posts are the areas in which a user can create/write content for their site's blog. WP gives users the option
...
2.5 Shortcode: The shortcode is a group of functions that can be used within the body of pages or posts inside WP.
